...
ENTITY gf_mod_256 IS
    ...
    PORT (
        ...
        message_pass_in : IN STD_LOGIC_VECTOR(255 - 1 DOWNTO 0); -- 239 bits for M=8, T=2


        result : OUT STD_LOGIC_VECTOR(M * T - 1 DOWNTO 0);
        next_parity : OUT STD_LOGIC;
        message_pass_out : OUT STD_LOGIC_VECTOR(255 - 1 DOWNTO 0)
    );
END ENTITY;
...
ARCHITECTURE RTL OF gf_mod_256 IS
    ...
    CONSTANT gen : STD_LOGIC_VECTOR(R DOWNTO 0) := "10110111101100011";
