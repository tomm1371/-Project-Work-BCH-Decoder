...
ARCHITECTURE rtl OF top_de10lite_decoder IS
    ...
    -- Phase-locked loops (PLLs) are used to generate stable clock signals at desired frequencies. 
    -- It's used to go above the 50MHz provided by the board and get a clean 200MHz clock for our design.
    component pll
        PORT
        (
...
BEGIN
    ...
    reader_inst : ENTITY work.codeword_decoder_reader
        GENERIC MAP (
    ...
    -- Instantiate the decoder to decode the codewords, read from ROM via the reader
